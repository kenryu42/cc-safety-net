...
import { deriveDoctorFindings as derivePorted } from '@next/cli/doctor/findings';
import type { DoctorReport } from '@next/hosts/doctor-types';
import { deriveDoctorFindings as deriveShipped } from '@/cli/doctor/findings';
 ...
 * silently turning a red report green. Each row is also a differential, so the ported catalog
 * cannot drift from the shipped one in wording, severity or order.
 */
