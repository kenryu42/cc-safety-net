...
import { writeStarterRulebook } from '@next/rules-manager/config-file';
import { GITHUB_FETCH_LIMITS } from '@next/rules-manager/resolver';
import {
  isRuleSyncResourceLimitError,
  RULE_SYNC_RESOURCE_LIMITS,
} from '@next/rules-manager/resource-limits';
import {
  createTempRoot,
  environmentFor,
  isolationEnv,
