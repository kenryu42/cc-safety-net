...
import { BLOCK_INTENTS, type BlockIntent, type Decision } from '@next/core/decision';
import * as next from '@next/core/denial';
import * as shipped from '@/integrations/denial';
import { formatBlockedMessage as formatWithSrc } from '@/integrations/format';
