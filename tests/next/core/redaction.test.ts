...
const PAIRS = [
  [next.redactSecrets, shipped.redactSecrets],
  [next.redactNonAssignmentSecrets, shipped.redactNonAssignmentSecrets],
  [next.redactEnvAssignmentValues, shipped.redactEnvAssignmentValues],
  [next.sanitizeDiagnosticText, shipped.sanitizeDiagnosticText],
  [next.getEnvAssignmentValues, shipped.getEnvAssignmentValues],
  [next.mightContainEnvAssignment, shipped.mightContainEnvAssignment],
] as const;
