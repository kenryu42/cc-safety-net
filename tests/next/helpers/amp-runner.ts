 ...
 * script and recorded, so one runner per side drives the shipped installer and the port over the
 * same hosted repository — no network, no real clone, no git binary. The checkout is deleted when
