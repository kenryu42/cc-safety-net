...
import {
  ...
  isShellSyntaxCheck,
  parseShellArgv,
} from '@next/gate/analyzer/shell-wrappers';
import {
  extractDashCArg as shippedExtractDashCArg,
  extractShellStartupLoaderMetadata as shippedExtractShellStartupLoaderMetadata,
...
/** Every wrapper argv the differential feeds both implementations. */
