...
import { detectClaudeShapeAgent as portedDetect } from '@next/hosts/hook/agent-detection';
import { detectClaudeShapeAgent as shippedDetect } from '@/integrations/hook/agent-detection';
