...
import {
  INSTALL_TARGETS as SHIPPED_INSTALL_TARGETS,
  orderInstallTargets as shippedOrderInstallTargets,
  runInstallTargetsInOrder as shippedRunInstallTargetsInOrder,
...
describe('install targets', () => {
  ...
  test('a selection is deduplicated and put back into catalog order', () => {
    expect(orderInstallTargets(SELECTION)).toEqual(shippedOrderInstallTargets(SELECTION));
