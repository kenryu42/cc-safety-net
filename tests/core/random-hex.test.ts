...
describe('randomHex16', () => {
  test('is sixteen lowercase hex digits, fresh on every call', () => {
    // The audit reader looks entries up by this id and the policy writer's temp-name regexes
    // expect exactly sixteen hex digits, so the width is part of the contract.
