...
import { wrapReason } from '@next/cli/explain/format-helpers';
import { isPluginEnabled } from '@next/cli/statusline';
...
import { loadPolicySnapshot } from '@next/core/policy/snapshot';
