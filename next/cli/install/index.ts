...
import { awaitWithSpinner, resolveAfterOptionalBanner } from '@next/cli/startup/banner';
import { colors } from '@next/cli/utils/colors';
...
} from '@next/hosts/antigravity-cli/install';
import { getIntegrationDisplayName } from '@next/hosts/catalog';
import { detectClaudeCode, hasClaudeInstalledPlugin } from '@next/hosts/claude-code/detect';
import { _getCopilotConfigHome } from '@next/hosts/copilot-cli/detect';
import {
...
import { installCursor, uninstallCursor } from '@next/hosts/cursor/install';
import { detectAllHooks } from '@next/hosts/detect/index';
import type { UpdateInfo } from '@next/hosts/doctor-types';
import { detectGeminiCLI } from '@next/hosts/gemini-cli/detect';
import { installGrokBuild, uninstallGrokBuild } from '@next/hosts/grok-build/install';
import { HERMES_AGENT_PLUGIN_NAME } from '@next/hosts/hermes-agent/artifact';
import { isHermesAgentPluginEnabled } from '@next/hosts/hermes-agent/detect';
import {
  installHermesAgent,
  readOwnedHermesAgentFiles,
  uninstallHermesAgent,
} from '@next/hosts/hermes-agent/install';
...
import {
  ...
  runNativeCommand,
  runNativeCommands,
} from '@next/hosts/install/native';
...
} from '@next/hosts/install/targets';
import type { InstallResult } from '@next/hosts/install/types';
import { detect as detectKimiCodeHook } from '@next/hosts/kimi-code/detect';
import { installKimiCode, uninstallKimiCode } from '@next/hosts/kimi-code/install';
import { OPENCLAW_PLUGIN_ID } from '@next/hosts/openclaw/artifact';
import {
  assertOpenClawPluginDirIsOurs,
  getOpenClawInstallCommands,
  verifyOpenClawPluginRuntime,
} from '@next/hosts/openclaw/install';
import {
  clearOpenCodeCache,
  uninstallOpenCode,
  verifyOpenCodePluginRuntime,
} from '@next/hosts/opencode/install';
import { getPiSettingsPath, isPiSafetyNetPackageSource } from '@next/hosts/pi/detect';
import { defaultVersionFetcher, type VersionFetcher } from '@next/hosts/system-info';
