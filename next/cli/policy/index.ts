...
import { policyCommand } from '@next/cli/commands/policy';
...
import { getProjectPolicyPath, getUserPolicyPath } from '@next/core/policy/paths';
import {
  normalizeGuiPolicy,
  projectPolicyProjection,
  writeUserPolicyFromGui,
} from '@next/core/policy/store';
import type { GuiPolicy } from '@next/core/policy/types';
