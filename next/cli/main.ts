...
import { runLogsCommand } from '@next/cli/audit-log';
import { type CommandName, findCommand } from '@next/cli/commands/index';
import { parseDoctorFlags, runDoctor } from '@next/cli/doctor/index';
