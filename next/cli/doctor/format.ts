...
import { renderTerminalText } from '@next/cli/utils/terminal';
import { describePolicyScope } from '@next/core/policy/types';
import { doctorIntegrationOrder, getIntegrationDisplayName } from '@next/hosts/catalog';
import type {
  ActivitySummary,
  ConfigSourceInfo,
  DoctorFinding,
  ...
  SystemInfo,
  UpdateInfo,
} from '@next/hosts/doctor-types';
import type { SelfTestSummary } from '@next/hosts/self-test';
