...
import { getConfigInfo } from '@next/cli/doctor/config';
import { getEnvironmentInfo } from '@next/cli/doctor/environment';
import { deriveDoctorFindings } from '@next/cli/doctor/findings';
import {
  ...
  formatUpdateSection,
} from '@next/cli/doctor/format';
import { getDoctorPosture } from '@next/cli/doctor/posture';
import { checkForUpdates } from '@next/cli/doctor/updates';
import { printInstallBanner } from '@next/cli/install/banner';
import { findRuleV2Leftovers } from '@next/cli/rule/sync-migrate';
import { resolveAfterOptionalBanner } from '@next/cli/startup/banner';
...
import { describeConfigState, loadPolicySnapshot } from '@next/core/policy/snapshot';
import { detectAllHooks } from '@next/hosts/detect/index';
import type { DoctorOptions, DoctorReport } from '@next/hosts/doctor-types';
import { runIntegrationSelfTest } from '@next/hosts/self-test';
import { getPackageVersion, getSystemInfo } from '@next/hosts/system-info';

export { parseDoctorFlags } from '@next/cli/doctor/flags';
