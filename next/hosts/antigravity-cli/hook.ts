...
import { createFailedClosedDenial, type IntegrationDenial } from '@next/core/denial';
import type { Environment, PathResolver } from '@next/core/environment';
...
import {
  ...
  ToolInputLimitError,
} from '@next/core/tool-input';
import { firstTrustedRoot, getToolRoute, resolveContainedCwd } from '@next/gate/intake';
import type { CommandToolKind, ToolCallContext } from '@next/gate/invocation';
