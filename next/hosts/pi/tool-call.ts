import {
  ...
  projectGuardDenial,
} from '@next/core/denial';
import { createProcessEnvironment, type PathResolver } from '@next/core/environment';
import { ENV_FLAGS, envTruthy, shouldRecordAllowedCommands } from '@next/core/policy/env';
import type { PolicySnapshotOptions } from '@next/core/policy/snapshot';
import { getNonCommandToolInputKind } from '@next/core/tool-input';
import { resolveContainedCwd } from '@next/gate/intake';
import type { CommandToolKind, ToolInvocation } from '@next/gate/invocation';
import { createToolInvocation } from '@next/gate/invocation';
import { type GuardDependencies, GuardEvaluationError } from '@next/gate/pipeline';
import { writeIntegrationDenialAudit } from '@next/hosts/audit';
import { evaluateRuntimeGuard } from '@next/hosts/runtime';
