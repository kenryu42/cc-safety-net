...
import { normalizeGuiPolicy } from '@next/core/policy/store';
import {
  AMP_MANAGED_HEADER,
  AMP_PLUGIN_DIRECTORY,
  AMP_PLUGIN_ENTRY,
} from '@next/hosts/amp/artifact';
import { type AmpRunner, runAmpCommand } from '@next/hosts/amp/run';
import { lstatOrUndefined, readRecord } from '@next/hosts/detect/context';
import type { InstallResult } from '@next/hosts/install/types';
import { getPackageVersion } from '@next/hosts/system-info';
