...
import * as toolRouting from '@next/core/tool-input';
import { resolveCanonicalCwd, resolveContainedCwd } from '@next/gate/intake';
import * as invocationDomain from '@next/gate/invocation';
...
import * as guardEngine from '@next/hosts/runtime';
