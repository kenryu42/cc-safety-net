...
import { shouldRecordAllowedCommands } from '@next/core/policy/env';
import * as toolRouting from '@next/core/tool-input';
import { isUsableDirectory } from '@next/gate/intake';
...
import { loadBuiltinCommands } from '@next/hosts/opencode/builtin-commands/commands';
