import type { PolicyFilesystemTarget } from '@next/core/io/safe-read';
import { writeJsonAtomic } from '@next/core/policy/config-file';
import { DEFAULT_CONFIG, type RulesConfig, readRulesConfig } from '@next/core/policy/rules-config';
