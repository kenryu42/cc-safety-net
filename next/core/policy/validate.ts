import { BLOCK_INTENTS } from '@next/core/decision';
import { COMMAND_PATTERN, MAX_REASON_LENGTH } from '@next/core/rules/constants';
import { DESTRUCTIVE_COMMAND_RULE_ID_SET } from '@next/core/rules/destructive';
import { SECRET_PROTECTION_RULE_ID_SET } from '@next/core/rules/secret';
import {
 ...
 * messages come out in, mirrors `schema.ts` exactly — `tests/next/core/policy/validate.test.ts`
