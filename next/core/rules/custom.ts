import { getMatchGlobalOptionsWithValues } from '@next/core/rules/custom-match-options';
import { getCustomRuleOptionsWithValues } from '@next/core/rules/custom-subcommand';
import type {
  CustomRuleMatch,
  DestructiveCommandRuleMatch,
  PolicyRule,
} from '@next/core/rules/types';
import { extractShortOpts, normalizeCommandToken } from '@next/core/shell/tokens';
