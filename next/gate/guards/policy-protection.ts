...
import { getProjectPolicyPath, getUserPolicyPath, POLICY_FILE } from '@next/core/policy/paths';
import type { ShellSyntaxFacts } from '@next/core/shell/projection';
...
import { stripWrappersForPathScan } from '@next/gate/analyzer/wrapper-prelude';
import type { SemanticFacts } from '@next/gate/facts';
import { createToolInvocation, type ToolCallContext, type ToolRoute } from '@next/gate/invocation';
import {
