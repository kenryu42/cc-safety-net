import type { Rulebook } from '@next/core/policy/rulebook';
...
import { analysisWordText, analyzedViewWords } from '@next/gate/analyzer/command-words';
import { stripEnvAssignmentWords } from '@next/gate/analyzer/wrapper-prelude';
