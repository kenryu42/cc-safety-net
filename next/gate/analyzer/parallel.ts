...
import { AWK_INTERPRETERS, SHELL_WRAPPERS } from '@next/core/rules/constants';
import { checkPolicyRuleMatch } from '@next/core/rules/custom';
import {
  type DestructiveCommandRuleId,
  destructiveCommandMatch,
} from '@next/core/rules/destructive';
import type { DestructiveCommandRuleMatch, PolicyRule } from '@next/core/rules/types';
import type { CommandWord } from '@next/core/shell/model';
import { normalizeCommandToken } from '@next/core/shell/tokens';
import { parseSimpleWords } from '@next/core/shell/traversal';
import type { AnalyzeNestedOverrides, PathResolver } from '@next/gate/analysis';
