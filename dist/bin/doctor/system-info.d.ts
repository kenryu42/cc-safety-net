 ...
 */
import type { PiProbeInfo, SystemInfo } from '@/bin/doctor/types';
/**
 ...
 */
export declare function getSystemInfo(fetcher?: VersionFetcher, options?: {
    cwd?: string;
    piProbeRunner?: PiProbeRunner;
}): Promise<SystemInfo>;
