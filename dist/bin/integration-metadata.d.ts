...
export declare const runtimeHookIntegrationMetadata: {
    ...
    flags: readonly ["-cc", "--claude-code"] | readonly ["-gc", "--gemini-cli"] | readonly ["-cp", "--copilot-cli"] | readonly ["-kc", "--kimi-cli"];
    description: "Run as Claude Code PreToolUse hook" | "Run as Gemini CLI BeforeTool hook" | "Run as Copilot CLI PreToolUse hook" | "Run as Kimi CLI PreToolUse hook";
